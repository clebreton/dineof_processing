...
from sandbox.carole.DeMarine.demarine_conf import region, supersampling, num_rows, product_format,compositing_type
from sandbox.carole.DeMarine.demarine_conf import output_Binned_Data, output_format
from waqss_processing.nasa.modis.seadas_processing.shared.utilities import getDOY, ensureTrailingSlash, exit_on_empty_list
from sandbox.carole.DeMarine.demarine_paths import modisL2_TSMBasePath_ns, modisL2_TSMBasePath_bs,modisL3_TSMBasePath
from sandbox.carole.DeMarine.demarine_conf import beamBinDir, l3binningDir
...
l3binningScript = beamBinDir + 'gpt.bat'
...
request_binning_block = ' <binningConfig>\n'

request_binning_block += ' <planetaryGrid>org.esa.beam.binning.support.SEAGrid</planetaryGrid>\n'
request_binning_block += ' <compositingType>'+ compositing_type +'</compositingType>\n'

request_binning_block += ' <numRows>'+ str(num_rows) +'</numRows>\n'
request_binning_block += ' <superSampling>'+ str(supersampling) +'</superSampling>\n'
request_binning_block += ' <maskExpr>!l2_flags.PRODWARN</maskExpr>\n'
...
request_update_block = ' <formatterConfig>\n'
